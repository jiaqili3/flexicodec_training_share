...
class ResidualVQ(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.RVQ_dropout = RVQ_dropout
        self.RVQ_dropout_weight = torch.tensor(RVQ_dropout_weight, requires_grad=False)
    ...
    def forward(self, x):
        ...
        used_layers = len(self.layers)
        if self.training and self.RVQ_dropout:
            used_layers = torch.multinomial(self.RVQ_dropout_weight, 1)[0]
