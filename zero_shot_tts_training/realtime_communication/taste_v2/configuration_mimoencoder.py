...
class MiMoAudioTokenizerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # New: optional mid-encoder downsampling to reach 12.5Hz tokens
        mid_downsample: bool = True,
        mid_downsample_stride: int = 2,
        mid_downsample_layer_idx: int | None = None,
        **kwargs,
    ):
        ...
        # New mid-downsample config
        self.mid_downsample = mid_downsample
        self.mid_downsample_stride = mid_downsample_stride
        self.mid_downsample_layer_idx = mid_downsample_layer_idx