...
class SnakeBeta(nn.Module):
    ...
    References:
        ...
        by Liu Ziyin, Tilman Hartwig, Masahito Ueda: https://arxiv.org/abs/2006.08195
    Examples:
        >>> a1 = snakebeta(256)
        >>> x = torch.randn(256)
        >>> x = a1(x)
...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        :param attention_head_dim:
        :param dropout:
        :param cross_attention_dim:
        :param activation_fn:
        :param num_embeds_ada_norm:
        :param attention_bias:
        :param only_cross_attention:
        :param double_self_attention:
        :param upcast_attention:
        :param norm_elementwise_affine:
        :param norm_type:
        :param final_dropout:
        """
        super().__init__()
