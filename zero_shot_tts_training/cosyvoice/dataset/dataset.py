...
if __name__ == "__main__":
    ...
    from .gluster_dataset import GlusterDataset

    ds = GlusterDataset(
        mnt_path="/gluster-ssd-tts/DATA_TTS",
        vault_list=["EN_F00001"],
        cfg=edict(
            {
                "w2v_path": "/gluster-ssd-tts/jiaqi_repos/w2v-bert-2",
                "preprocess": {
                    "sample_rate": 16000,
                    "min_dur": 3,
                    "max_dur": 30,
    ...
    ds = DataList(ds.metas, shuffle=True, partition=True)
