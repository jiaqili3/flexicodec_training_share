...
from cosyvoice.transformer.basic_transformer_block import BasicTransformerBlock


class SinusoidalPosEmb(torch.nn.Module):
    """
    SinusoidalPosEmb Module
    """
